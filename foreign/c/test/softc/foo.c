...
static void store (const softc_entity_t *ptr, softc_datamodel_t *data_model)
{
  ...
  softc_datamodel_append_string(data_model, "str", self->props.str);
...
static void load (softc_entity_t *ptr, const softc_datamodel_t *data_model)
{
  ...
  softc_datamodel_get_string(data_model, "str", &self->props.str);
...
void foo_property_set_str (foo_s* self, const char *value)
{
  ...
  self->props.str = realloc(self->props.str, 1+len);
  strcpy(self->props.str, value);
  strcat(self->props.str, "\0");
}
